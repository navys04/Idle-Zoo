...
namespace FarmingEngine
{
    ...
    public class PlayerCharacterCraft : MonoBehaviour
    {
        ...
        {
            character.Data.UnlockID(craft_id);
        }
		
		public bool HasLearnt(string craft_id)
        {
            return character.Data.IsIDUnlocked(craft_id);
        }

        public int CountTotalCrafted(CraftData craftable)
        {
            if(craftable != null)
                return character.Data.GetCraftCount(craftable.id);
            return 0;
        }
        ...
        {
            if (craftable != null)
                character.Data.ResetCraftCount(craftable.id);
        }

        public void ResetCraftCount()
        {
            character.Data.ResetCraftCount();
        }
