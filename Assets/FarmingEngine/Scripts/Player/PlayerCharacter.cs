...
namespace FarmingEngine
{
    ...
    public class PlayerCharacter : MonoBehaviour
    {
        ...
        private void Update()
        {
            ...
            if (auto_move && !is_action && auto_move_select != null && move_dir.magnitude < auto_move_select.GetUseRange(this))
            {
                auto_move = false;
            ...
            if (auto_move && !is_action && character_craft.ClickedBuild() && current_buildable != null && move_dir.magnitude < current_buildable.GetBuildRange(this))
            {
                auto_move = false;
        ...
        {
            if (can_cancel_action && is_action)
            {
